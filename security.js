  ...
  brain.traverse((child) => {
    if (child.isMesh && child.name === "Curren") {
      ...
      child.userData.braindescript =
        "attacker may attempt to manipulate an AI system's training data to introduce biases or influence its decision-making.";
      child.userData.braindescript1 =
        "attacker may target an AI system's infrastructure to disrupt its functionality or gain unauthorized access to sensitive data. ";
    }
    ...
    if (child.isMesh && child.name === "Ethica") {
      child.userData = {
        description:
          "Governments and industry organizations have a role to play in ensuring the security of AI.",
      };
