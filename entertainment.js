...
loader.load("Entertainment_Occipital.glb", (gltf) => {
  ...
  brain.traverse((child) => {
    if (child.isMesh && child.name === "Curren") {
      child.userData = {
        description:
          "AI is already being used in various entertainment fields, from creating realistic virtual characters in video games to generating personalized recommendations on streaming platforms.",
      };
    ...
    if (child.isMesh && child.name === "Potentia") {
      child.userData = {
        description:
    ...
    if (child.isMesh && child.name === "Ethica") {
      child.userData = {
        description:
          "As with any technology, the use of AI in entertainment raises ethical and social concerns that must be addressed.",
      };
    ...
    if (child.isMesh && child.name === "Cas") {
      ...
      child.userData.braindescript1 =
        "n film, AI can be used to analyze audience reactions to test screenings and make edits based on their feedback.";
    }
